...
print(out)
print(len(out))
indexes_ = [indexesFromSentence(voc, sentence) for sentence in inp]
indexes_
...
print("How zip_longest works:")
a = ["A", "B", "C"]
b = [1,2,3]
print(list(zip(a,b))) #[('A', 1), ('B', 2), ('C', 3)]

#if a list is increased:
a2 = ["A", "B", "C", "D", "E"]

print(list(zip(a2,b))) #[('A', 1), ('B', 2), ('C', 3)] - zip works until min length of the 2 arrays is reached

#zip_longest
list(itertools.zip_longest(a2,b)) #default fillValue = None
...
bidim = [a2,b]
print(bidim)
print(list(itertools.zip_longest(bidim))) #without * [(['A', 'B', 'C', 'D', 'E'],), ([1, 2, 3],)]
print(list(itertools.zip_longest(*bidim))) #with * [('A', 1), ('B', 2), ('C', 3), ('D', None), ('E', None)]
print(list(itertools.zip_longest(*bidim, fillvalue="*")))
...
import numpy as np
print(list(itertools.zip_longest(*biglist))) #None
print("")
print(list(itertools.zip_longest(*biglist, fillvalue=0)))
...
#print(indexes_)
l = [len(sent) for sent in indexes_]
print(l)
print(max(l))
...
pprint(indexes_)
pprint(len(zeroPadding(indexes_))) #num of rows
result = zeroPadding(indexes_)#max_len * batch_size
pprint(result)
...
print("Test indexesFromSentence:", indexesFromSentence(voc, pairs[1][0]))
...
"""
Without squeeze(1)
Tar:  tensor([2, 1, 5, 4, 0])
tensor([[0.1883, 0.1794, 0.1273, 0.0998, 0.1633, 0.1515, 0.0902],
        [0.2218, 0.1242, 0.1603, 0.0906, 0.0909, 0.0880, 0.2242],
        [0.1376, 0.1506, 0.1013, 0.1144, 0.2143, 0.0978, 0.1839],
        [0.1049, 0.1341, 0.0854, 0.1606, 0.1076, 0.2106, 0.1967],
        [0.1923, 0.1726, 0.0964, 0.2067, 0.0985, 0.1261, 0.1074]])
tensor([[2],
        [1],
        [5],
        [4],
...
With squeeze(1):
Tar:  tensor([2, 1, 5, 4, 0])
tensor([[0.1437, 0.1159, 0.0937, 0.1896, 0.1082, 0.1702, 0.1788],
        [0.1320, 0.0816, 0.1143, 0.1186, 0.1937, 0.1689, 0.1910],
        [0.1399, 0.1141, 0.1374, 0.1249, 0.1837, 0.2131, 0.0870],
        [0.1125, 0.1743, 0.0974, 0.1020, 0.1984, 0.1762, 0.1392],
        [0.1943, 0.1927, 0.0931, 0.1687, 0.1117, 0.0828, 0.1567]])
tensor([2, 1, 5, 4, 0])
...
gat_ten = torch.gather(dec_o, 1, tar) #get softmax sores for the expected correct prediction
print(gat_ten)
...
tensor([1.6689, 1.9366, 2.4488, 1.9484, 2.4234])
"""

print(log_gat_ten)
print(log_gat_ten.squeeze(1))
...
decoder = LuongAttnDecoderRNN(att_model, embedding, hidden_size, voc.num_words, decoder_n_layers, dropout)
